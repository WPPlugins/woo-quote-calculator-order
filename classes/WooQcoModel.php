...
<?php
	...
	static function export(){
		...
		if(isset($_GET["id"])){	 //Single quote export
			$fileName = "../wp-content/plugins/woo-quote-calculator-and-order/export/woo-simple-quote-".$_GET["id"]."-".date('Y-m-d').".csv";
			$query = "SELECT *, NULL AS id FROM $dbTable where id={$_GET['id']}";
		}
		else{  //Entire table export
			$fileName = "../wp-content/plugins/woo-quote-calculator-and-order/export/woo-simple-quote-". date('Y-m-d').".csv";
